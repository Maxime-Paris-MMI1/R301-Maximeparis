          ...
          <div class="py-1">
            <MenuItem v-slot="{ active }">
                <router-link to="/edit/[id]">
                    <a href="#" :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-sm']">Id Maison</a>
                </router-link>
            </MenuItem>
            <MenuItem v-slot="{ active }">
                <router-link to="/edit/new">
                    <a href="#" :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-sm']">New Maison</a>
                </router-link>
            </MenuItem>
          </div>
        </MenuItems>
