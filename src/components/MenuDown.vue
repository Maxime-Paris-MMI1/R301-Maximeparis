          ...
          <div class="py-1">
            <MenuItem v-slot="{ active }">
                <router-link to="/quartier/quartiercommune">
                    <a href="#" :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-sm']">Quartier commune</a>
                </router-link>
            </MenuItem>
            <MenuItem v-slot="{ active }">
                <router-link to="/quartier/newquartier">
                    <a href="#" :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-sm']">New quartier</a>
                </router-link>
            </MenuItem>
            <MenuItem v-slot="{ active }">
